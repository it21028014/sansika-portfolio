...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_390ukm5', 'template_mo1vfkh', formRef.current, {
        publicKey: 'uPibP1x5u-YXzuUkV',
      })
      .then(
        (result) => {
          setSuccess(true);
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h3>Mail</h3>
          <span>sansika.kodi@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h3>Address</h3>
          <span>122/3B, IDH Road, Kotikawatta</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h3>Phone</h3>
          <span>+(94) 77 499 2781</span>
        </motion.div>
      </motion.div>
